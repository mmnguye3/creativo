...
**Why:** The user's live OpenAI key has no dall-e-3 access, and the fal.ai account can hit "Exhausted balance" (403), so gpt-image-1 became the only working image path in production (July 2026). As of July 8, 2026 the fal.ai account is topped up with a fresh key and fal is the primary again.
