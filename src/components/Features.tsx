...
const Features = () => {
  const features = [{
    ...
    return <section className="py-24 bg-gradient-to-b from-amber-50/30 via-orange-50/20 to-background relative overflow-hidden">
      {/* Decorative underlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-orange-100/40 via-amber-50/30 to-orange-200/50"></div>
