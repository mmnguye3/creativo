    ...
    <section className="relative py-20 px-4 bg-gradient-to-br from-white via-orange-50 to-yellow-50 overflow-hidden">
      ...
      <div className="container mx-auto text-center relative z-10 max-w-5xl">
        ...
        <div className="animate-fade-in" style={{ animationDelay: '0.6s' }}>
          <Button 
            size="lg" 
            className="text-xl px-12 py-6 bg-orange-500 hover:bg-orange-600 text-white rounded-full shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all duration-300"
