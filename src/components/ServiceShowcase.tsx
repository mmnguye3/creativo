    ...
    <section id="services" className="py-20 px-4 bg-white">
      <div className="container mx-auto max-w-6xl">
            ...
            >
              {(service as any).popular && (
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                  <Badge className="bg-gradient-to-r from-orange-500 to-amber-500 text-white px-4 py-1 rounded-full">
                    🔥 Most Popular
                  </Badge>
                </div>
              )}
              ...
              <CardContent className="space-y-6">
                ...
                <Button 
                  ...
                  className="w-full bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white py-3 rounded-lg font-semibold transition-all duration-300 hover:shadow-lg"
                >
        ...
        <div className="text-center mt-16 p-8 bg-gradient-to-r from-orange-50 to-amber-50 rounded-2xl">
          ...
          <Button 
            variant="outline" 
            className="border-orange-500 text-orange-500 hover:bg-gradient-to-r hover:from-orange-500 hover:to-amber-500 hover:text-white"
