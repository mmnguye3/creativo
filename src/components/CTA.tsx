...
const CTA = () => {
  return (
    <section className="py-24 bg-gradient-to-b from-amber-50/30 via-orange-50/20 to-background relative overflow-hidden">
      {/* Decorative underlay */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-card border border-white/10 rounded-3xl p-12 relative overflow-hidden">
            ...
            <div className="absolute bottom-6 left-6 w-16 h-16 bg-gradient-glass rounded-full animate-float opacity-15 flex items-center justify-center" style={{ animationDelay: '-2s' }}>
