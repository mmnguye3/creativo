  ...
  const handleConnectStripe = async () => {
    ...
    try {
      ...
      if (result.onboardingComplete) {
        ...
        toast({ title: "Stripe Connected", description: "Your payment account is ready to receive payments." });
        return;
      }
      ...
      toast({ title: "Connection failed", description: err.message ?? "Failed to connect Stripe account.", variant: "destructive" });
    } finally {
        ...
        <TabsContent value="payments" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Connect a Stripe account to receive payments from your clients directly.
                Cretivo takes a 10% platform fee; the rest goes to your Stripe account.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-5">
              ...
              {stripeLoading ? (
                ...
                <div className="flex items-center gap-3 p-3 bg-green-50 border border-green-200 rounded-lg" data-testid="stripe-status-connected">
                  ...
                  <div>
                    ...
                    {stripeStatus.stripeAccountId && (
                      <p className="text-xs text-green-500 mt-0.5 font-mono">{stripeStatus.stripeAccountId}</p>
                    )}
                  </div>
                  <Badge className="ml-auto bg-green-100 text-green-700 border-green-200">Live</Badge>
                </div>
                ...
                <div className="flex items-center gap-3 p-3 bg-amber-50 border border-amber-200 rounded-lg" data-testid="stripe-status-incomplete">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-amber-600">Finish setting up your Stripe account to start receiving payments.</p>
                  </div>
                </div>
              ) : (
                <div className="flex items-center gap-3 p-3 bg-stone-50 border border-stone-200 rounded-lg" data-testid="stripe-status-not-connected">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-stone-500">Connect a Stripe account to enable payment links for your orders.</p>
                  </div>
                </div>
              )}
                ...
                {!stripeStatus?.onboardingComplete && (
                  ...
                  >
                    {connectingStripe ? (
                      ...
                      <><ExternalLink className="w-4 h-4 mr-2" />Resume Onboarding</>
                    ) : (
              ...
              <div className="rounded-lg border border-blue-200 bg-blue-50 p-3">
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-xs text-blue-700 space-y-1">
                    ...
                    <p>All payments are in sandbox mode. Use test card <code className="bg-blue-100 px-1 rounded">4242 4242 4242 4242</code> (any future expiry, any CVC) to simulate a successful payment.</p>
                    <p>Switch to live mode by replacing <code className="bg-blue-100 px-1 rounded">STRIPE_SECRET_KEY</code> with your live <code className="bg-blue-100 px-1 rounded">sk_live_…</code> key in Supabase edge function secrets.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2 pt-2 border-t border-stone-100">
                ...
                <ol className="text-xs text-muted-foreground space-y-1.5 list-decimal list-inside">
                  ...
                  <li>Click <strong>Send Payment Link</strong> to generate a Stripe Checkout link and email it to the customer.</li>
                  <li>Customer pays securely via Stripe. Cretivo deducts a 10% platform fee; the rest transfers to your Stripe account automatically.</li>
