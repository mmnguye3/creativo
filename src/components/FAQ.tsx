  ...
  const faqs = [
    {
      ...
      answer: "You will first want to determine which types of designs you need on a monthly basis which helps you determine which bucket you will fall into. Then, you can choose a price point that fits your budget and volume needs. You can also book a call to speak to a Cretivo expert to help determine what plan fits your needs the best."
    },
    {
